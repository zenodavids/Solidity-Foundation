...
######## we use this this function to check the url of our API
import requests
...
###### we use this expresion below to check the contents of our API
...
# note that this module only works on the online textbook
